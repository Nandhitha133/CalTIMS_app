...
const styles = StyleSheet.create({
  ...
  kpiGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: scale(12), marginBottom: verticalScale(16) },
  kpiCard: { width: '48%', backgroundColor: '#fff', padding: scale(12), borderRadius: scale(16), borderWidth: 1, borderColor: '#f1f5f9', flexDirection: 'column', gap: scale(8) },
  kpiIconBox: { width: scale(32), height: verticalScale(32), borderRadius: scale(8), justifyContent: 'center', alignItems: 'center' },
  kpiContent: {},
  ...
  searchRow: { flexDirection: 'row', alignItems: 'center', gap: scale(12) },
  searchBar: { flex: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', paddingHorizontal: scale(16), borderRadius: scale(16), borderWidth: 1, borderColor: '#e2e8f0', height: verticalScale(52) },
  searchInput: { flex: 1, marginLeft: scale(12), fontSize: moderateScale(15), color: '#1e293b' },
  filterBtn: { width: scale(52), height: verticalScale(52), backgroundColor: '#fff', borderRadius: scale(16), borderWidth: 1, borderColor: '#e2e8f0', justifyContent: 'center', alignItems: 'center' },
  filterBtnActive: { borderColor: '#c7d2fe', backgroundColor: '#eef2ff' },
  filterDot: { position: 'absolute', top: verticalScale(12), right: scale(12), width: scale(8), height: verticalScale(8), borderRadius: scale(4), backgroundColor: '#4f46e5' },
  listContainer: { gap: scale(16), paddingBottom: verticalScale(40) },
  leaveCard: { backgroundColor: '#fff', borderRadius: scale(16), padding: scale(16), borderWidth: 1, borderColor: '#f1f5f9', shadowColor: '#000', shadowOffset: { width: 0, height: verticalScale(2) }, shadowOpacity: 0.05, shadowRadius: scale(8), elevation: 2 },
  leaveCardHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: verticalScale(16) },
  leaveAvatar: { width: scale(44), height: verticalScale(44), borderRadius: scale(22), backgroundColor: '#e0e7ff', justifyContent: 'center', alignItems: 'center', marginRight: scale(12) },
  ...
  leaveBadge: { paddingHorizontal: scale(10), paddingVertical: verticalScale(4), borderRadius: scale(8), backgroundColor: '#ecfdf5' },
  ...
  leaveDivider: { height: verticalScale(1), backgroundColor: '#f8fafc', marginHorizontal: scale(-16), marginBottom: verticalScale(16) },
  ...
  leaveActionsBox: { flexDirection: 'row', gap: scale(12) },
  leaveActionBtnPrimary: { width: scale(36), height: verticalScale(36), borderRadius: scale(18), backgroundColor: '#e0e7ff', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#c7d2fe' },
  leaveActionBtnSecondary: { width: scale(36), height: verticalScale(36), borderRadius: scale(18), backgroundColor: '#f1f5f9', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#e2e8f0' },
  leaveActionBtnDanger: { width: scale(36), height: verticalScale(36), borderRadius: scale(18), backgroundColor: '#fef2f2', justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: '#fecaca' },

  emptyState: { padding: scale(40), alignItems: 'center', justifyContent: 'center', backgroundColor: '#fff', borderRadius: scale(20) },
  emptyText: { color: '#94a3b8', fontSize: moderateScale(15), fontWeight: '500' },

  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'flex-end' },
  modalContainer: { backgroundColor: '#fff', borderTopLeftRadius: scale(24), borderTopRightRadius: scale(24), padding: scale(24) },
  ...
  modalFooter: { flexDirection: 'row', gap: scale(12), marginTop: verticalScale(24) },
  clearBtn: { flex: 1, paddingVertical: verticalScale(14), backgroundColor: '#f1f5f9', borderRadius: scale(12), alignItems: 'center' },
  clearBtnText: { fontSize: moderateScale(15), fontWeight: '700', color: '#475569' },
  applyBtn: { flex: 2, paddingVertical: verticalScale(14), backgroundColor: '#4f46e5', borderRadius: scale(12), alignItems: 'center' },
  applyBtnText: { fontSize: moderateScale(15), fontWeight: '700', color: '#fff' },

  viewHeaderCard: { backgroundColor: '#fff', borderRadius: scale(24), padding: scale(20), borderWidth: 1, borderColor: '#f1f5f9', shadowColor: '#000', shadowOffset: { width: 0, height: verticalScale(4) }, shadowOpacity: 0.05, shadowRadius: scale(12), elevation: 3, marginBottom: verticalScale(32) },
  viewAvatar: { width: scale(64), height: verticalScale(64), borderRadius: scale(20), backgroundColor: '#4f46e5', justifyContent: 'center', alignItems: 'center', marginRight: scale(16) },
  ...
  ctcBox: { backgroundColor: '#f8fafc', borderRadius: scale(16), padding: scale(16), alignItems: 'flex-start', borderWidth: 1, borderColor: '#f1f5f9' },
  ...
  subSectionTitleEarning: { fontSize: moderateScale(10), fontWeight: '800', color: '#94a3b8', letterSpacing: 1, marginBottom: verticalScale(8), borderLeftWidth: scale(2), borderLeftColor: '#10b981', paddingLeft: scale(8) },
  subSectionTitleDeduction: { fontSize: moderateScale(10), fontWeight: '800', color: '#94a3b8', letterSpacing: 1, marginBottom: verticalScale(8), borderLeftWidth: scale(2), borderLeftColor: '#ef4444', paddingLeft: scale(8) },

  breakdownCard: { backgroundColor: '#fff', borderRadius: scale(20), padding: scale(20), borderWidth: 1, borderColor: '#f1f5f9' },
  ...
  complianceCard: { backgroundColor: '#f8fafc', borderRadius: scale(20), padding: scale(20), marginBottom: verticalScale(16) },
  complianceHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: verticalScale(16) },
  dot: { width: scale(8), height: verticalScale(8), borderRadius: scale(4), marginRight: scale(8) },
  ...
  payoutCard: { backgroundColor: '#0f172a', borderRadius: scale(24), padding: scale(24), position: 'relative', overflow: 'hidden', marginBottom: verticalScale(24) },
  ...
  payoutDivider: { height: verticalScale(1), backgroundColor: 'rgba(255,255,255,0.1)', marginBottom: verticalScale(12) },
  payoutSub: { fontSize: moderateScale(9), fontWeight: '800', color: 'rgba(255,255,255,0.4)', letterSpacing: 1 },

  modifyBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#4f46e5', borderRadius: scale(16), padding: scale(16), gap: scale(8), marginBottom: verticalScale(40) },
