...
const styles = StyleSheet.create({
  ...
  metricTabs: { flexDirection: 'row', backgroundColor: '#e2e8f0', borderRadius: scale(12), padding: scale(4) },
  metricTab: { paddingHorizontal: scale(16), paddingVertical: verticalScale(8), borderRadius: scale(8) },
  metricTabActive: { backgroundColor: '#fff', shadowColor: '#000', shadowOffset: { width: 0, height: verticalScale(1) }, shadowOpacity: 0.1, shadowRadius: scale(2), elevation: 2 },
  ...
  actionBtn: { width: scale(40), height: verticalScale(40), borderRadius: scale(12), backgroundColor: '#0f172a', justifyContent: 'center', alignItems: 'center' },
