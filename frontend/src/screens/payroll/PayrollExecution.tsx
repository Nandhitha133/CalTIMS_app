...
const styles = StyleSheet.create({
  ...
  headerArea: { paddingHorizontal: moderateScale(16), paddingTop: verticalScale(16), paddingBottom: verticalScale(24), backgroundColor: '#fff', borderBottomWidth: 1, borderBottomColor: '#f1f5f9' },
  ...
  bulkBtn: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#6366f1', paddingHorizontal: scale(16), paddingVertical: verticalScale(10), borderRadius: moderateScale(12), gap: moderateScale(6) },
  bulkBtnText: { color: '#fff', fontSize: moderateScale(12), fontWeight: '800' },

  pickersRow: { flexDirection: 'row', gap: moderateScale(12) },
  pickerBox: { flex: 1, backgroundColor: '#f8fafc', borderWidth: 1, borderColor: '#e2e8f0', borderRadius: moderateScale(12), padding: moderateScale(12) },
  ...
  kpiScroll: { paddingHorizontal: moderateScale(16), gap: moderateScale(12), marginTop: verticalScale(24), marginBottom: verticalScale(16) },
  kpiCard: { padding: moderateScale(16), borderRadius: moderateScale(20), minWidth: scale(140) },
  ...
  readinessCard: { marginHorizontal: moderateScale(16), marginBottom: verticalScale(24), backgroundColor: '#0f172a', borderRadius: moderateScale(24), padding: moderateScale(20) },
  readinessHeader: { flexDirection: 'row', alignItems: 'center', gap: moderateScale(8), marginBottom: verticalScale(20) },
  readinessIconWrap: { width: scale(32), height: verticalScale(32), borderRadius: moderateScale(10), backgroundColor: 'rgba(255,255,255,0.1)', justifyContent: 'center', alignItems: 'center' },
  ...
  progressBarBg: { height: verticalScale(6), backgroundColor: 'rgba(255,255,255,0.1)', borderRadius: moderateScale(3), overflow: 'hidden', marginBottom: verticalScale(20) },
  progressBarFill: { height: '100%', backgroundColor: '#10b981', borderRadius: moderateScale(3) },
  
  blocksRow: { flexDirection: 'row', gap: moderateScale(12) },
  blockBox: { flex: 1, padding: moderateScale(12), borderRadius: moderateScale(12) },
  blockBoxHeader: { flexDirection: 'row', alignItems: 'center', gap: moderateScale(6), marginBottom: verticalScale(4) },
  ...
  controlsArea: { paddingHorizontal: moderateScale(16), marginBottom: verticalScale(16) },
  searchBar: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', paddingHorizontal: scale(16), borderRadius: moderateScale(16), borderWidth: 1, borderColor: '#e2e8f0', height: verticalScale(50), marginBottom: verticalScale(12) },
  ...
  filterScroll: { gap: moderateScale(8), paddingBottom: verticalScale(8) },
  filterPill: { paddingHorizontal: scale(16), paddingVertical: verticalScale(8), borderRadius: moderateScale(20), backgroundColor: '#fff', borderWidth: 1, borderColor: '#e2e8f0' },
  ...
  listContainer: { paddingHorizontal: moderateScale(16), gap: moderateScale(12) },
  empCard: { backgroundColor: '#fff', borderRadius: moderateScale(20), padding: moderateScale(16), borderWidth: 1, borderColor: '#f1f5f9' },
  empHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: verticalScale(16) },
  empInfoGroup: { flexDirection: 'row', alignItems: 'center', gap: moderateScale(12) },
  empAvatar: { width: scale(40), height: verticalScale(40), borderRadius: moderateScale(12), backgroundColor: '#eef2ff', justifyContent: 'center', alignItems: 'center' },
  ...
  empActionBtn: { padding: moderateScale(8), backgroundColor: '#f8fafc', borderRadius: moderateScale(10) },

  empMetricsGrid: { flexDirection: 'row', backgroundColor: '#f8fafc', borderRadius: moderateScale(12), padding: moderateScale(12) },
  empMetricCol: { flex: 1 },
  ...
  statusGroup: { flexDirection: 'row', alignItems: 'center', gap: moderateScale(4) },
  statusText: { fontSize: moderateScale(10), fontWeight: '800' },
  
  payBadge: { paddingHorizontal: scale(8), paddingVertical: verticalScale(4), borderRadius: moderateScale(8), alignSelf: 'flex-start' },
  payBadgeText: { fontSize: moderateScale(9), fontWeight: '800' },

  emptyState: { padding: moderateScale(40), alignItems: 'center', justifyContent: 'center' },
