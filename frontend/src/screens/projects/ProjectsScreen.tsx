...
const styles = StyleSheet.create({
  ...
  statsContainer: { flexDirection: 'row', flexWrap: 'wrap', gap: moderateScale(12), marginBottom: verticalScale(20), justifyContent: 'space-between' },
  statCard: { width: '48%', backgroundColor: 'white', borderRadius: moderateScale(16), padding: moderateScale(16), borderWidth: 1, borderColor: '#f1f5f9', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 8, elevation: 2, minHeight: verticalScale(110) },
  ...
  filterTitle: { fontSize: moderateScale(14), fontWeight: '600', color: '#1e293b', marginBottom: verticalScale(12) },
  ...
  gridContainer: { flexDirection: 'row', flexWrap: 'wrap', gap: moderateScale(12) },
  gridCard: { backgroundColor: 'white', borderRadius: moderateScale(16), borderWidth: 1, borderColor: '#e2e8f0', marginBottom: verticalScale(16), overflow: 'hidden', shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 4, elevation: 2, width: '100%' },
  ...
  employeeInfo: { flexDirection: 'row', alignItems: 'center', gap: moderateScale(12), flex: 1 },
  employeeAvatar: { width: scale(40), height: verticalScale(40), borderRadius: moderateScale(20), backgroundColor: '#eef2ff', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#c7d2fe' },
  ...
  employeeId: { fontSize: moderateScale(12), color: '#64748b', marginTop: verticalScale(2) },
  gridStatusBadge: { paddingHorizontal: scale(8), paddingVertical: verticalScale(4), borderRadius: moderateScale(12) },
  gridStatusText: { fontSize: moderateScale(10), fontWeight: '600' },
  cardContent: { padding: moderateScale(16), gap: moderateScale(8) },
  infoRow: { flexDirection: 'row', alignItems: 'center', gap: moderateScale(8) },
  infoText: { fontSize: moderateScale(13), color: '#475569', flex: 1 },
  gridProgressSection: { marginTop: verticalScale(8) },
  gridProgressBar: { height: verticalScale(4), backgroundColor: '#e2e8f0', borderRadius: moderateScale(2), overflow: 'hidden' },
  gridProgressFill: { height: '100%', backgroundColor: '#3b82f6', borderRadius: moderateScale(2) },
  gridProgressText: { fontSize: moderateScale(9), color: '#64748b', marginTop: verticalScale(4) },
  cardFooter: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: moderateScale(12), borderTopWidth: 1, borderTopColor: '#f1f5f9', backgroundColor: '#fafafa' },
  footerLeft: { flex: 1 },
  cardActions: { flexDirection: 'row', gap: moderateScale(8) },
  actionBtn: { width: scale(36), height: verticalScale(36), borderRadius: moderateScale(18), alignItems: 'center', justifyContent: 'center', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.05, shadowRadius: 1, elevation: 1 },
...
const modalStyles = StyleSheet.create({
  ...
  sectionHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: verticalScale(8), marginBottom: verticalScale(4) },
  sectionTitle: { fontSize: moderateScale(14), fontWeight: '700', color: '#1e293b' },
  addMemberBtn: { flexDirection: 'row', alignItems: 'center', gap: moderateScale(6), paddingVertical: verticalScale(6), paddingHorizontal: scale(12), borderRadius: moderateScale(8), backgroundColor: '#eff6ff' },
  addMemberText: { fontSize: moderateScale(12), fontWeight: '600', color: '#3b82f6' },
  field: { gap: moderateScale(6), marginBottom: verticalScale(4) },
  label: { fontSize: moderateScale(13), fontWeight: '600', color: '#334155' },
  smallLabel: { fontSize: moderateScale(11), fontWeight: '600', color: '#64748b' },
  input: { borderWidth: 1, borderColor: '#e2e8f0', borderRadius: moderateScale(12), paddingHorizontal: scale(16), paddingVertical: verticalScale(10), fontSize: moderateScale(14), color: '#1e293b', backgroundColor: '#f8fafc' },
  smallInput: { borderWidth: 1, borderColor: '#e2e8f0', borderRadius: moderateScale(8), paddingHorizontal: scale(8), paddingVertical: verticalScale(6), fontSize: moderateScale(12), color: '#1e293b', backgroundColor: '#f8fafc' },
  selectButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderWidth: 1, borderColor: '#e2e8f0', borderRadius: moderateScale(12), paddingHorizontal: scale(16), paddingVertical: verticalScale(10), backgroundColor: '#f8fafc' },
  selectButtonText: { fontSize: moderateScale(14), color: '#1e293b', flex: 1 },
  placeholderText: { color: '#94a3b8' },
  switchRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingVertical: verticalScale(8) },
  switchLabel: { fontSize: moderateScale(13), fontWeight: '600', color: '#334155' },
  textArea: { height: verticalScale(80), textAlignVertical: 'top' },
  memberRow: { backgroundColor: '#f8fafc', borderRadius: moderateScale(12), borderWidth: 1, borderColor: '#e2e8f0', padding: moderateScale(12), gap: moderateScale(8), marginBottom: verticalScale(8) },
  memberSelectContainer: { width: '100%' },
  memberInputsRow: { flexDirection: 'row', alignItems: 'flex-end', gap: moderateScale(8) },
  removeMemberBtn: { width: scale(32), height: verticalScale(32), borderRadius: moderateScale(8), backgroundColor: '#fef2f2', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#fca5a5' },
  footer: { flexDirection: 'row', gap: moderateScale(12), padding: moderateScale(20), borderTopWidth: 1, borderTopColor: '#e2e8f0' },
  cancelButton: { flex: 1, backgroundColor: '#f1f5f9', paddingVertical: verticalScale(12), borderRadius: moderateScale(12), alignItems: 'center' },
  cancelButtonText: { fontSize: moderateScale(14), fontWeight: '600', color: '#64748b' },
  submitButton: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: moderateScale(8), backgroundColor: '#3b82f6', paddingVertical: verticalScale(12), borderRadius: moderateScale(12) },
...
const detailModalStyles = StyleSheet.create({
  ...
  infoGrid: { gap: moderateScale(12), marginBottom: verticalScale(20) },
  infoItem: { flexDirection: 'row', alignItems: 'center', gap: moderateScale(12), backgroundColor: '#f8fafc', borderRadius: moderateScale(12), padding: moderateScale(12) },
  infoLabel: { fontSize: moderateScale(10), fontWeight: '600', color: '#64748b' },
  infoValue: { fontSize: moderateScale(13), color: '#1e293b', fontWeight: '500', marginTop: verticalScale(2) },
  descSection: { marginBottom: verticalScale(20) },
  sectionTitle: { fontSize: moderateScale(14), fontWeight: '700', color: '#1e293b', marginBottom: verticalScale(10) },
  descText: { fontSize: moderateScale(13), color: '#475569', lineHeight: moderateScale(18), backgroundColor: '#f8fafc', padding: moderateScale(12), borderRadius: moderateScale(12) },
  settingsSection: { marginBottom: verticalScale(20) },
  settingRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: verticalScale(10), borderBottomWidth: 1, borderBottomColor: '#f1f5f9' },
  settingLabel: { fontSize: moderateScale(13), color: '#475569' },
  settingValue: { fontSize: moderateScale(13), fontWeight: '600', color: '#1e293b' },
  teamSection: { marginBottom: verticalScale(20) },
  teamMemberCard: { flexDirection: 'row', alignItems: 'center', gap: moderateScale(12), backgroundColor: '#f8fafc', borderRadius: moderateScale(12), padding: moderateScale(12), marginBottom: verticalScale(8) },
  memberAvatar: { width: scale(36), height: verticalScale(36), borderRadius: moderateScale(18), backgroundColor: '#eff6ff', alignItems: 'center', justifyContent: 'center' },
  memberAvatarText: { fontSize: moderateScale(14), fontWeight: '700', color: '#3b82f6' },
  memberInfo: { flex: 1 },
  memberName: { fontSize: moderateScale(13), fontWeight: '600', color: '#1e293b' },
  memberRole: { fontSize: moderateScale(11), color: '#64748b', marginTop: verticalScale(2) },
  memberAllocation: { alignItems: 'flex-end' },
  memberAllocationText: { fontSize: moderateScale(12), fontWeight: '600', color: '#10b981' },
  memberHoursText: { fontSize: moderateScale(10), color: '#64748b', marginTop: verticalScale(2) },
  emptyTeamText: { fontSize: moderateScale(13), color: '#94a3b8', textAlign: 'center', paddingVertical: verticalScale(12) },
  footer: { flexDirection: 'row', gap: moderateScale(12), padding: moderateScale(20), borderTopWidth: 1, borderTopColor: '#e2e8f0' },
  editButton: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: moderateScale(8), backgroundColor: '#eff6ff', paddingVertical: verticalScale(12), borderRadius: moderateScale(12), borderWidth: 1, borderColor: '#bfdbfe' },
  editButtonText: { fontSize: moderateScale(14), fontWeight: '600', color: '#3b82f6' },
  closeButton: { flex: 1, backgroundColor: '#1e293b', paddingVertical: verticalScale(12), borderRadius: moderateScale(12), alignItems: 'center', justifyContent: 'center' },
...
const deleteModalStyles = StyleSheet.create({
  ...
  message: { fontSize: moderateScale(13), color: '#64748b', textAlign: 'center', marginBottom: verticalScale(24), lineHeight: moderateScale(18) },
  ...
  cancelButtonText: { fontSize: moderateScale(14), fontWeight: '600', color: '#64748b' },
  deleteButton: { flex: 1, paddingVertical: verticalScale(12), borderRadius: moderateScale(12), backgroundColor: '#ef4444', alignItems: 'center', justifyContent: 'center' },
