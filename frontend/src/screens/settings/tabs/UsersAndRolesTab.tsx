  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.description}>Manage user accounts, assign roles, and control access levels.</Text>
        <View style={styles.placeholderCard}>
          <Text style={styles.placeholderText}>User and role management coming soon...</Text>
        </View>
      </ScrollView>
    </View>
  );
