  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <Text style={styles.title}>Compliance & Locks</Text>
        <Text style={styles.description}>Set up regulatory compliance rules and data editing locks.</Text>
        <View style={styles.placeholderCard}>
          <Text style={styles.placeholderText}>Compliance and locks coming soon...</Text>
        </View>
      </ScrollView>
    </View>
  );
