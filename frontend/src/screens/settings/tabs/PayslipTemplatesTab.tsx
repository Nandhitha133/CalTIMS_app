...
export default function PayslipTemplatesTab() {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <Text style={styles.title}>Payslip Templates</Text>
        <Text style={styles.description}>Customize payslip layouts and included information.</Text>
        <View style={styles.placeholderCard}>
          <Text style={styles.placeholderText}>Payslip templates coming soon...</Text>
        </View>
      </ScrollView>
    </View>
  );
