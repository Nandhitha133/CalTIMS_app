  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.description}>Configure your app branding, colors, and visual theme.</Text>
        <View style={styles.placeholderCard}>
          <Text style={styles.placeholderText}>Branding configuration coming soon...</Text>
        </View>
      </ScrollView>
    </View>
  );
