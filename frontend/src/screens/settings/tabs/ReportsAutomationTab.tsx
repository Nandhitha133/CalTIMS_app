  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        <Text style={styles.title}>Reports & Automation</Text>
        <Text style={styles.description}>Schedule automated reports and data exports.</Text>
        <View style={styles.placeholderCard}>
          <Text style={styles.placeholderText}>Reports automation coming soon...</Text>
        </View>
      </ScrollView>
    </View>
  );
